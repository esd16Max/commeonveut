...
beginto = input("Enter beginning port: ") #Debut de la pkage de port a scanner
stopto  = input("Enter stoping port: ") #Fin de la pkage de port a scanner
...
for port in range(beginto,stopto):  
